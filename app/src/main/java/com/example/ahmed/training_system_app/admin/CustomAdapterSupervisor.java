...
public class CustomAdapterSupervisor extends ArrayAdapter<DataModelStudentList> implements View.OnClickListener{
    ...
    public CustomAdapterSupervisor(ArrayList<DataModelStudentList> data, Context context, AppCompatActivity appActivity) {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            case R.id.ad_row_edit_student_container:
                ...
                ad_Edit_Supervisor_fragment ad_edit_student_fragment=new ad_Edit_Supervisor_fragment();
